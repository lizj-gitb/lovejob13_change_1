    ...
    private void addData() {
        LoveJob.getUserHomeInfos(userPid, new OnAllParameListener() {
            ...
            public void onSuccess(final ThePerfectGirl thePerfectGirl) {
                ...
                Glide.with(context).load(StaticParams.QiNiuYunUrl + thePerfectGirl.getData().getUserInfoDTO().getPortraitId()).into(imgFOthersLogo);
                ...
                ThreadPoolUtils.getInstance().addTask(new Runnable() {
                    ...
                    public void run() {
                        try {
                            final Bitmap bitmap = Glide.with(context).load(StaticParams.QiNiuYunUrl + thePerfectGirl.getData().getUserInfoDTO().getBackground())
