...
import com.v.rapiddev.http.okhttp3.WebSocketListener;
import com.v.rapiddev.http.okhttp3.internal.NamedRunnable;
import com.v.rapiddev.http.okhttp3.internal.Util;
import com.v.rapiddev.http.okhttp3.internal.platform.Platform;
import okio.BufferedSink;
import okio.BufferedSource;
import okio.ByteString;
import okio.Okio;

import static com.v.rapiddev.http.okhttp3.internal.platform.Platform.INFO;
import static com.v.rapiddev.http.okhttp3.internal.ws.WebSocketProtocol.CLOSE_ABNORMAL_TERMINATION;
import static com.v.rapiddev.http.okhttp3.internal.ws.WebSocketProtocol.CLOSE_CLIENT_GOING_AWAY;
import static com.v.rapiddev.http.okhttp3.internal.ws.WebSocketProtocol.CLOSE_PROTOCOL_EXCEPTION;
...
import static com.v.rapiddev.http.okhttp3.internal.ws.WebSocketReader.FrameCallback;
...
public abstract class RealWebSocket implements WebSocket, FrameCallback {
  ...
  @Override
  public final void onReadMessage(ResponseBody message) throws IOException {
    readerListener.onMessage(message);
  }

  @Override
  public final void onReadPing(ByteString buffer) {
  ...
  @Override
  public final void sendMessage(RequestBody message) throws IOException {
  ...
  @Override
  public final void sendPing(ByteString payload) throws IOException {
